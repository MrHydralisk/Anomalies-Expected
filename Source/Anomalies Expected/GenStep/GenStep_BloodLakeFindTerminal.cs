...
namespace AnomaliesExpected
{
    public class GenStep_BloodLakeFindTerminal : GenStep
    {
        ...
        public override void Generate(Map map, GenStepParams parms)
        {
            ...
            List<IntVec3> initPositions = new List<IntVec3>() { new IntVec3(0, 0, 0), new IntVec3(map.Size.x, 0, 0), new IntVec3(0, 0, map.Size.z), map.Size };
            ...
            {
                CellFinder.TryFindRandomCellNear(initPos, map, map.Size.x, (IntVec3 c) => Validator(c, map), out pos, 50);
