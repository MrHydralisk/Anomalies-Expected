...
namespace AnomaliesExpected
{
    public class PsychicRitualDef_AEAskingProvider : PsychicRitualDef_InvocationCircle
    {
        ...
        public override List<PsychicRitualToil> CreateToils(PsychicRitual psychicRitual, PsychicRitualGraph graph)
        {
            ...
            PsychicRitualToil_InvokeHorax psychicRitualToil_InvokeHorax = list.FirstOrDefault((PsychicRitualToil prt) => prt is PsychicRitualToil_InvokeHorax) as PsychicRitualToil_InvokeHorax;
            list.Replace(psychicRitualToil_InvokeHorax, new PsychicRitualToil_AEAskingProvider(InvokerRole, readOnlyDictionary.TryGetValue(InvokerRole), TargetRole, readOnlyDictionary.TryGetValue(TargetRole), ChanterRole, readOnlyDictionary.TryGetValue(ChanterRole), DefenderRole, readOnlyDictionary.TryGetValue(DefenderRole), RequiredOffering)
            {
                hoursUntilHoraxEffect = psychicRitualToil_InvokeHorax.hoursUntilHoraxEffect,
                hoursUntilOutcome = psychicRitualToil_InvokeHorax.hoursUntilOutcome,
